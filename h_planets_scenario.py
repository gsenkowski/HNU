...
# HORIZONS Planets Scenario
class HPlanetsScenario(scenario.Scenario):
    def __init__(self, date_time):
        self.ssb = '500@0' # Solar system barycenter in HORIZONS
        self.masses = masses_planets.masses
        self.gm = gm_planets.gm
...
def main():
    scen = HPlanetsScenario(datetime.datetime(2021, 6, 23, 14, 48, 53))
    ...
    print(len(masses_planets.masses))
